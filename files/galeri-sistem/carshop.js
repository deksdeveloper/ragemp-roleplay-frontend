...
function updateVehicleDisplay() {
    ...
    for (var i = startIndex; i < endIndex; i++) {
        ...
        if (i === vehicleIndex) {
            ...
            document.getElementById("selected-car-price").textContent = "Fiyat: $" + vehicles[i].price;
            document.getElementById("selected-car-topspeed").textContent = "Maksimum Hız: " + vehicles[i].topspeed;
