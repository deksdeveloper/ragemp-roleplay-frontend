...
function onButtonClick(button)
{
	if(dialog_name != null && dialog_name != "")
	{
		...
		mp.trigger("dialog_response", dialog_name, button, list_selected, inputtext_value, inputpassword_value);
	}
}

function createDialog(name, caption, info, buttons, list_items, text_input, password_input)
{
	if(name != "")
	{
		dialog_name = name;
