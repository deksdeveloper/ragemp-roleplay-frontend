...
mp.events.add('ESP_ADMIN', () => {
	...
	if(esptoggle == 0) mp.game.graphics.notify('WH: ~r~Kapalı');
	else if(esptoggle == 1) mp.game.graphics.notify('WH: ~g~Sadece Oyuncular');
	else if(esptoggle == 2) mp.game.graphics.notify('WH: ~g~Sadece Araçlar');
	else if(esptoggle == 3) mp.game.graphics.notify('WH: ~g~Oyuncular ve Araçlar');
